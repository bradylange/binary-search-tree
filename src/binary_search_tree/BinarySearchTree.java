 ...
 * Language: Java
 * Date: 4/11/18
 * Description: This class contains attributes that relate to a circular linked list data structure 
 * Data Structure Functions: Add, Remove, IsBST, inBST, Traverse, leavesCount, heightCount
 */
